...
import { REDIS_HOST, REDIS_PORT, REDIS_PASSWORD, REDIS_USERNAME, NODE_ENV, REDIS_HOST_LOCAL, REDIS_PORT_LOCAL, REDIS_PASSWORD_LOCAL } from "../utils/config.js";
...
Command.setReplyTransformer("hgetall", async (data) => {
